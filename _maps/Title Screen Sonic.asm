...
byte_A898:	spriteHeader
	...
	spritePiece	8, $30, 4, 3, $23, 0, 0, 0, 0
	spritePiece	$28, $30, 4, 3, $2F, 0, 0, 0, 0
	spritePiece	0, $48, 4, 2, $3B, 0, 0, 0, 0
	spritePiece	$20, $48, 3, 2, $43, 0, 0, 0, 0
...
byte_A8CB:	spriteHeader
	...
	spritePiece $40, $48, 1, 1, $1CE, 0, 0, 0, 0
	spritePiece $20, $60, 1, 1, $1CF, 0, 0, 0, 0
	spritePiece 8, $20, 4, 4, $1A9, 0, 0, 0, 0
	spritePiece $28, $20, 1, 4, $1B9, 0, 0, 0, 0
	spritePiece 8, $10, 4, 3, $4F, 0, 0, 0, 0
	spritePiece $28, $10, 4, 3, $5B, 0, 0, 0, 0
	spritePiece $48, $18, 1, 2, $67, 0, 0, 0, 0
	spritePiece 0, $28, 1, 3, $69, 0, 0, 0, 0
	spritePiece 8, $28, 4, 4, $6C, 0, 0, 0, 0
	spritePiece $28, $28, 4, 4, $7C, 0, 0, 0, 0
	spritePiece $48, $30, 1, 3, $8C, 0, 0, 0, 0
...
byte_A917:	spriteHeader
	...
	spritePiece $48, $38, 1, 1, $1CE, 0, 0, 0, 0
	spritePiece $28, $50, 1, 1, $1CF, 0, 0, 0, 0
	spritePiece 8, $10, 4, 3, $4F, 0, 0, 0, 0
	spritePiece $28, $10, 4, 3, $5B, 0, 0, 0, 0
	spritePiece $48, $18, 1, 2, $67, 0, 0, 0, 0
 	spritePiece 0, $28, 1, 3, $69, 0, 0, 0, 0
...
byte_A96D:	spriteHeader
	...
	spritePiece	$48, $18, 1, 1, $C6, 0, 0, 0, 0
	spritePiece	$48, $20, 2, 3, $C7, 0, 0, 0, 0
	spritePiece	$48, $38, 1, 1, $CD, 0, 0, 0, 0
	spritePiece	8, $30, 4, 2, $CE, 0, 0, 0, 0
	spritePiece	$28, $30, 4, 3, $D6, 0, 0, 0, 0
	spritePiece	$10, $40, 3, 4, $E2, 0, 0, 0, 0
	spritePiece	$28, $48, 3, 1, $EE, 0, 0, 0, 0
...
byte_A9AF:	spriteHeader
	...
	spritePiece	$18, $28, 4, 3, $118, 0, 0, 0, 0
	spritePiece	$38, $28, 4, 3, $124, 0, 0, 0, 0
	spritePiece	$10, $28, 1, 2, $130, 0, 0, 0, 0
	spritePiece	$10, $40, 4, 3, $132, 0, 0, 0, 0
	spritePiece	$30, $40, 2, 3, $13E, 0, 0, 0, 0
